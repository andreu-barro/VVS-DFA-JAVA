...
public class StateRendimientoTest {
     ...
     */
    @Test
    public final void getStateRendimientoTest() {
        List<State> testElements = new ArrayList<State>();
        for (int i = 0; i < itNumber; i++) {
            testElements.add(new State("a"));
        }

        EtmPoint point = etmMonitor
                .createPoint("StateRendimientoTest:getState");

        for (State a : testElements) {
            a.getState();
        }
